...
- Recibe el `título` de la lista (ej. "Compras", "Pendientes"). - Recibe cualquier cantidad de cadenas de texto mediante `*elementos`. 
...
## Función main: Debe llamar a generar_lista al menos 3 veces pasando 1, 3 y 4 elementos respectivamente, e imprimir los resultados.